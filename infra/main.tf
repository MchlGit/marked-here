    ...
    image_repository {
      ...
      image_configuration {
        ...
        runtime_environment_variables = {
          ...
          ConnectionStrings__Default = "Host=${aws_db_instance.postgres.address};Port=5432;Database=${var.db_name};Username=${var.db_name};Password=${var.db_password};Ssl Mode=Require;Trust Server Certificate=true"
        }
      }
    }
  }
